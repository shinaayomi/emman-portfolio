...
(function($) {
  $(window).load(function() {
    ...
    $("#preloader")
      .delay(400)
      .fadeOut("medium"); // will fade out the white DIV that covers the website.
  });
  ...
  $(document).ready(function() {
    ...
    $(".close-share-bottom, #content, .open-menu, .open-more").click(
      function() {
    ...
    $(".countdown").countdown({
      ...
      render: function(data) {
        $(this.el).html(
          "<div class='countdown-box box-years'><div class='countdown-years'>" +
            this.leadingZeros(data.years, 2) +
            "</div><span>years</span></div><div class='countdown-box box-days'><div class='countdown-days'>" +
            this.leadingZeros(data.days, 2) +
            "</div><span>days</span></div><div class='countdown-box box-hours'><div class='countdown-hours'>" +
            this.leadingZeros(data.hours, 2) +
            "</div><span>hours</span></div><div class='countdown-box box-minutes'><div class='countdown-minutes'>" +
            this.leadingZeros(data.min, 2) +
            "</div><span>min</span></div><div class='countdown-box box-seconds'><div class='countdown-seconds'>" +
    ...
    $(".adaptive-one-activate").click(function() {
      ...
      $(".adaptive-two-activate, .adaptive-three-activate").removeClass(
    ...
    $(".adaptive-two-activate").click(function() {
      ...
      $(this).addClass("active-adaptive-style");
      $(".adaptive-three-activate, .adaptive-one-activate").removeClass(
        "active-adaptive-style"
      );
      return false;
    });
    ...
    $(".adaptive-three-activate").click(function() {
      ...
      $(".portfolio-adaptive").removeClass("adaptive-one");
      $(this).addClass("active-adaptive-style");
      $(".adaptive-two-activate, .adaptive-one-activate").removeClass(
        "active-adaptive-style"
      );
      return false;
    });
    ...
    $(".switch, .switch-icon").click(function() {
      $(this)
        .parent()
        .find(".switch-box-content")
        .slideToggle(200);
      $(this)
        .parent()
        .find(".switch-box-subtitle")
        .slideToggle(200);
      return false;
    });
    ...
    $(".deploy-toggle-3").click(function() {
      ...
      $(this)
        .find("em strong")
        .toggleClass("toggle-3-active-ball");
      $(this)
        .find("em")
        .toggleClass("toggle-3-active-background");
      return false;
    });
